  ...
  render() {
    return (
      <div className="flex items-center w-full h-full">
        <div
          className="flex hover:z-20 w-full h-4/5 bg-center bg-no-repeat bg-contain hover:bg-cover transition-all duration-100 ease-linear delay-100 transform hover:scale-125 md:hover:scale-110 cursor-pointer"
          style={{
            backgroundImage: `url('${this.props.item.imgUrl}')`,
          }}
        >
          <div className="flex-1 p-1 w-full h-full text-black bg-gradient-to-b from-black via-transparent to-black opacity-0 hover:opacity-100 transition-all duration-100 ease-linear delay-100 transform select-none">
